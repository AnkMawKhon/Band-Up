...
<div class="container" style="text-align: center">
    ...
    <div class="card shadow" data-aos="fade-up" style="width: 70rem;">
        ...
        <p class="card-text">"Band Up" website was created using Laravel MVC framework, and different plugins were used for the functions of the website. Before developing the website, the developers have little to no MVC knowledge, and this project has taught them a lot. The development of the website has provided insights for what is needed for using APIs, how to use APIs, and how they can work with the website.The website has potential of being successful if handled with care. It provides a solution for a problem among the musicians, who wants to go to music specific events. There were some limitation in relation to time given, and resources available, but the website has all the features needed for a music event website. For future development, new features such as search function, google login, and video uploading should be considered. For reference, the following are the plugins and APIs that were used by the website.</p>
        </div>
    </div>  
    <br><br>
    <div class="container">
